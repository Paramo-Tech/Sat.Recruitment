...
namespace Sat.Recruitment.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Just for let you know that i know about ExtensionsMethods and to work whith a "database" in this project
            //I will need it for the user duplicates validations
