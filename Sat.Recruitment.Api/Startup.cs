...
namespace Sat.Recruitment.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IUserRepository, FileRepository>();
            //services.AddScoped<IUserRepository, XMLRepository>();

            services.Configure<FilePathsConfiguration>(Configuration.GetSection("FilePaths"));
